...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers(PathPages.AUTH_ALL_RESOURCES,  PathPages.COMPANY_ALL_RESOURCES)
                .permitAll()
                .requestMatchers(PathPages.ADMIN_BRANCH).hasAnyAuthority(ERole.ADMIN.name(), ERole.MANAGER.name(), ERole.CEO.name())
                .requestMatchers(PathPages.USER_BRANCH).hasAnyAuthority(ERole.USER.name())
                .anyRequest()
                .authenticated()
                .and()
                .sessionManagement()
