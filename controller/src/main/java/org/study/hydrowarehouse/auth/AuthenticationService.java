...
import org.study.hydrowarehouse.security.JwtService;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse authentication(AuthenticationRequest request) {
        ...
        org.study.hydrowarehouse.entity.User user = userDao.getUserByEmail(request.getEmail()).orElseThrow();
     ...
     */
    private Collection<SimpleGrantedAuthority> getAuthorities(org.study.hydrowarehouse.entity.User user) {
