...
public class PathPages {
    ...
    public static final String USER_FIND_BY_COUNTRY = ADMIN_BRANCH + USER + "/get_all_by_country";
    public static final String USER_FIND_BY_COMPANY = ADMIN_BRANCH + USER + "/get_all_by_company";
